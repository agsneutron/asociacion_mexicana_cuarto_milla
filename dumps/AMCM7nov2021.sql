...
--
-- Table structure for table `amcm_credito`
--

DROP TABLE IF EXISTS `amcm_credito`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `amcm_credito` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  KEY `amcm_credito_pago_id_8558ffc0_fk_amcm_pago_id` (`pago_id`),
  CONSTRAINT `amcm_credito_pago_id_8558ffc0_fk_amcm_pago_id` FOREIGN KEY (`pago_id`) REFERENCES `amcm_pago` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amcm_credito`
--

LOCK TABLES `amcm_credito` WRITE;
/*!40000 ALTER TABLE `amcm_credito` DISABLE KEYS */;
/*!40000 ALTER TABLE `amcm_credito` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `amcm_ejemplares` (
  ...
  KEY `amcm_ejemplares_estatus_id_3c84719a_fk_amcm_estatusejemplar_id` (`estatus_id`),
  CONSTRAINT `amcm_ejemplares_cuadra_id_7c3b65fc_fk_amcm_cuadras_id` FOREIGN KEY (`cuadra_id`) REFERENCES `amcm_cuadras` (`id`),
  CONSTRAINT `amcm_ejemplares_estatus_id_3c84719a_fk_amcm_estatusejemplar_id` FOREIGN KEY (`estatus_id`) REFERENCES `amcm_estatusejemplar` (`id`),
...
INSERT INTO `amcm_ejemplares` VALUES (1,'ESPEJO FINITO CASH',3,54.6,'BAYO','LOOKING NOTES','FLIER HORSE','',1,1,1,2),(2,'DANCESAQQARA',1,43,'NEGRO','THE FIRST LADY','LH TOAST TO FLASH','',1,1,2,1),(3,'TRES SOLO',1,45,'PINTO','RUNAWAY','GIRL PAULA','',2,1,1,1),(4,'BUYTIST',2,56,'BLANCO','TROYANO','MERRI CORONA','',2,1,2,1);
/*!40000 ALTER TABLE `amcm_ejemplares` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amcm_estatusejemplar`
--

DROP TABLE IF EXISTS `amcm_estatusejemplar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `amcm_estatusejemplar` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(100) NOT NULL,
  `descripcion` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `amcm_estatusejemplar`
--

LOCK TABLES `amcm_estatusejemplar` WRITE;
/*!40000 ALTER TABLE `amcm_estatusejemplar` DISABLE KEYS */;
INSERT INTO `amcm_estatusejemplar` VALUES (1,'ACTIVO','Caballo activo'),(2,'RETIRADO','Ejemplar retirado por muerte o enfermedad');
/*!40000 ALTER TABLE `amcm_estatusejemplar` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `amcm_pago` (
  ...
  `cuadra_id` int NOT NULL,
  `evento_id` int NOT NULL,
  `estatus_credito` varchar(15) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `amcm_pago_cuadra_id_8de6409f_fk_amcm_cuadras_id` (`cuadra_id`),
  KEY `amcm_pago_evento_id_4fa0dac9_fk_amcm_evento_id` (`evento_id`),
  KEY `amcm_pago_cuota_id_b6ffb760_fk_amcm_cuotaevento_id` (`cuota_id`),
  CONSTRAINT `amcm_pago_cuadra_id_8de6409f_fk_amcm_cuadras_id` FOREIGN KEY (`cuadra_id`) REFERENCES `amcm_cuadras` (`id`),
  CONSTRAINT `amcm_pago_cuota_id_b6ffb760_fk_amcm_cuotaevento_id` FOREIGN KEY (`cuota_id`) REFERENCES `amcm_cuotaevento` (`id`),
  CONSTRAINT `amcm_pago_evento_id_4fa0dac9_fk_amcm_evento_id` FOREIGN KEY (`evento_id`) REFERENCES `amcm_evento` (`id`)
...
INSERT INTO `amcm_pago` VALUES (6,10000,'cuota vii derby','2021-10-28','2021-10-28','efectivo',6,1,3,'PAGADO');
/*!40000 ALTER TABLE `amcm_pago` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amcm_pago_ejemplar`
--

DROP TABLE IF EXISTS `amcm_pago_ejemplar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `amcm_pago_ejemplar` (
  `id` int NOT NULL AUTO_INCREMENT,
  `pago_id` int NOT NULL,
  `ejemplares_id` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `amcm_pago_ejemplar_pago_id_ejemplares_id_bfb8516f_uniq` (`pago_id`,`ejemplares_id`),
  KEY `amcm_pago_ejemplar_ejemplares_id_16ca10d7_fk_amcm_ejemplares_id` (`ejemplares_id`),
  CONSTRAINT `amcm_pago_ejemplar_ejemplares_id_16ca10d7_fk_amcm_ejemplares_id` FOREIGN KEY (`ejemplares_id`) REFERENCES `amcm_ejemplares` (`id`),
  CONSTRAINT `amcm_pago_ejemplar_pago_id_0a273d27_fk_amcm_pago_id` FOREIGN KEY (`pago_id`) REFERENCES `amcm_pago` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amcm_pago_ejemplar`
--

LOCK TABLES `amcm_pago_ejemplar` WRITE;
/*!40000 ALTER TABLE `amcm_pago_ejemplar` DISABLE KEYS */;
INSERT INTO `amcm_pago_ejemplar` VALUES (1,6,2);
/*!40000 ALTER TABLE `amcm_pago_ejemplar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amcm_reasignaejemplar`
--

DROP TABLE IF EXISTS `amcm_reasignaejemplar`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `amcm_reasignaejemplar` (
  `id` int NOT NULL AUTO_INCREMENT,
  `cuadra_id` int NOT NULL,
  `ejemplar_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `amcm_reasignaejemplar_cuadra_id_66cc2161_fk_amcm_cuadras_id` (`cuadra_id`),
  KEY `amcm_reasignaejemplar_ejemplar_id_658317a4_fk_amcm_ejemplares_id` (`ejemplar_id`),
  CONSTRAINT `amcm_reasignaejemplar_cuadra_id_66cc2161_fk_amcm_cuadras_id` FOREIGN KEY (`cuadra_id`) REFERENCES `amcm_cuadras` (`id`),
  CONSTRAINT `amcm_reasignaejemplar_ejemplar_id_658317a4_fk_amcm_ejemplares_id` FOREIGN KEY (`ejemplar_id`) REFERENCES `amcm_ejemplares` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amcm_reasignaejemplar`
--

LOCK TABLES `amcm_reasignaejemplar` WRITE;
/*!40000 ALTER TABLE `amcm_reasignaejemplar` DISABLE KEYS */;
/*!40000 ALTER TABLE `amcm_reasignaejemplar` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `amcm_recibo`
--

DROP TABLE IF EXISTS `amcm_recibo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `amcm_recibo` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `amcm_recibo_pago_id_36559874_fk_amcm_pago_id` (`pago_id`),
  CONSTRAINT `amcm_recibo_pago_id_36559874_fk_amcm_pago_id` FOREIGN KEY (`pago_id`) REFERENCES `amcm_pago` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `amcm_recibo`
--

LOCK TABLES `amcm_recibo` WRITE;
/*!40000 ALTER TABLE `amcm_recibo` DISABLE KEYS */;
INSERT INTO `amcm_recibo` VALUES (1,999,'xx','2021-10-29',6),(2,345,'xx','2021-10-29',6),(3,899,'xxx','2021-10-29',6);
/*!40000 ALTER TABLE `amcm_recibo` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(21,'amcm','condicionesevento'),(28,'amcm','credito'),(11,'amcm','cuadras'),(18,'amcm','cuotaevento'),(12,'amcm','cuotas'),(7,'amcm','descuentos'),(8,'amcm','ejemplares'),(25,'amcm','estatusejemplar'),(14,'amcm','evento'),(17,'amcm','fechasevento'),(23,'amcm','inscripcion'),(16,'amcm','limite'),(9,'amcm','nacionalidad'),(24,'amcm','pago'),(26,'amcm','reasignaejemplar'),(27,'amcm','recibo'),(22,'amcm','registrocuotaevento'),(10,'amcm','sexo'),(15,'amcm','tipocondicion'),(13,'amcm','tipocuota'),(20,'amcm','tipoevento'),(19,'amcm','tipofecha'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
-- Dump completed on 2021-11-07 15:21:01
